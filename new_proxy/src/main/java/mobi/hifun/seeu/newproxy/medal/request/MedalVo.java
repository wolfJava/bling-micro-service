package mobi.hifun.seeu.newproxy.medal.request;
...
public class MedalVo implements Serializable {
    ...
    private static final long serialVersionUID = 292939935951695475L;
    ...
    public String toString() {
        return "MedalVo{" +
                ...
                ", medalType=" + medalType +
                ", needFragmentsNum=" + needFragmentsNum +
                ", price=" + price +
                ", sort=" + sort +
                ", introduceCaption='" + introduceCaption + '\'' +
                ", obtainRouteCaption='" + obtainRouteCaption + '\'' +
                ", rewardCaption='" + rewardCaption + '\'' +
                ", destroyCaption='" + destroyCaption + '\'' +
                ", isDel=" + isDel +
                ...
                ", taskNum=" + taskNum +
                ", fragmentsWaringNum=" + fragmentsWaringNum +
                ", sellCaption='" + sellCaption + '\'' +
